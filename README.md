...
6. [PEV: Protocol Extractable Value (/Protocol-level MEV)](https://github.com/0xNineteen/blog.md/blob/master/mev-v2/index.md): How protocols are in the position to extract value (value which is currently being extracted by validators) which can go back to the protocol's dao, treasury, or users. 
